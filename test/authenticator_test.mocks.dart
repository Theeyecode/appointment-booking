...
// in appointment_booking_app/test/authenticator_test.dart.
...
import 'package:appointment_booking_app/features/user/data/user_backend.dart'
    as _i7;
import 'package:appointment_booking_app/features/user/models/user.dart' as _i8;
import 'package:mockito/mockito.dart' as _i1;
import 'package:mockito/src/dummies.dart' as _i4;
import 'package:riverpod/src/framework.dart' as _i2;
import 'package:riverpod/src/internals.dart' as _i9;
...
/// A class which mocks [IAuthenticator].
///
/// See the documentation for Mockito's code generation for more information.
class MockIAuthenticator extends _i1.Mock implements _i3.IAuthenticator {
  MockIAuthenticator() {
  ...
  @override
  _i5.Future<_i6.AuthResult> loginWithGoogle() => (super.noSuchMethod(
        Invocation.method(
          #loginWithGoogle,
          [],
        ),
        returnValue: _i5.Future<_i6.AuthResult>.value(_i6.AuthResult.aborted),
      ) as _i5.Future<_i6.AuthResult>);

  @override
  _i5.Future<_i6.AuthResult> registerWithEmailPassword(
    String? email,
    String? password,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i5.Future<_i6.AuthResult> signInWithEmailPassword(
    String? email,
    String? password,
  ) =>
      (super.noSuchMethod(
...
/// A class which mocks [UserManagement].
///
/// See the documentation for Mockito's code generation for more information.
class MockUserManagement extends _i1.Mock implements _i7.UserManagement {
  MockUserManagement() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i5.Future<bool> createUser(_i8.UserModel? user) => (super.noSuchMethod(
        Invocation.method(
          #createUser,
          [user],
        ),
  ...
  @override
  _i5.Future<_i8.UserModel?> getUser(String? userId) => (super.noSuchMethod(
        Invocation.method(
          #getUser,
          [userId],
        ),
  ...
  @override
  _i5.Future<bool> updateUser(_i8.UserModel? user) => (super.noSuchMethod(
        Invocation.method(
          #updateUser,
          [user],
        ),
...
class MockProviderRef<State> extends _i1.Mock
    implements _i9.ProviderRef<State> {
  MockProviderRef() {
    _i1.throwOnMissingStub(this);
  }
